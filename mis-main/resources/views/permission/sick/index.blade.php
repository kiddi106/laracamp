        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Sick Permission</a></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    {{-- <a href="{{ route('permission.sick.create') }}" class="btn btn-sm btn-success modal-show float-right" title="New Form"><i class="fa fa-plus"></i> New Form</a> --}}
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <br>
                <!-- date picker -->
                <form method="POST" action="{{ route('permission.sick.store') }}" id="form" enctype="multipart/form-data">
                    @csrf
...
function datatables() {
    $(function () {
        $('#datatable').DataTable({
			...
			order: [[1, "desc" ]],
            ajax: {
                url: "{{ route('permission.sick.dataTables') }}",
                type: 'post',
                headers: {
...
$('#create').click(function () {
    ...
    $.ajax({
        ...
        url: "{{ route('permission.sick.store') }}", // point to server-side PHP script 
