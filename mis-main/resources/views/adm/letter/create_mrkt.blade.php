<form method="POST" action="{{ route('adm.store_mrkt') }}">
    @csrf
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group row" style="margin-bottom:unset;">
                ...
                <div class="col-md-6">
                    <label class=" col-form-label" style="font-weight:normal">{{ $nomor_surat_mrkt }}</label>
                    @error('ext')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group row">
                <label for="from_mrkt" class="col-md-4 col-form-label text-md-right">{{ __('From') }}</label>
        
                <div class="col-md-6">
                    <input type="text" class="form-control" name="from_mrkt" id="from_mrkt">
                    @error('destination')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group row">
                <label for="to__mrkt" class="col-md-4 col-form-label text-md-right">{{ __('To') }}</label>
        
                <div class="col-md-6">
                    <input type="text" class="form-control" name="to_mrkt" id="to_mrkt">
                    @error('destination')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
...
<script>
    ...
    $('#marketing_table').DataTable().ajax.reload();
});
</script>