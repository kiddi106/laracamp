  ...
  <script>
    $('#custom-tabs-four-PKS-tab').click(function(){
      $('#PKS_table').DataTable({
        ...
        order: [[0, 'desc']],
        ajax: {
          url: "{!! route('adm.MylistLetter_PKS') !!}",
          type: 'POST',
          headers: {
    ...
    $('#custom-tabs-four-Marketing-tab').click(function(){
      $('#marketing_table').DataTable({
        ...
        order: [[0, 'desc']],
        ajax: {
          url: "{!! route('adm.MylistLetter_mrkt') !!}",
          type: 'POST',
          headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          },
    ...
    $('#custom-tabs-four-Sales-tab').click(function(){
      $('#sales_table').DataTable({
        ...
        order: [[0, 'desc']],
        ajax: {
          url: "{!! route('adm.MylistLetter_sales') !!}",
          type: 'POST',
          headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          },
    ...
    $('#custom-tabs-four-Outgoing-tab').click(function(){
      $('#outgoing_table').DataTable({
        ...
        order: [[0, 'desc']],
        ajax: {
          url: "{!! route('adm.MylistLetter_out') !!}",
          type: 'POST',
          headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          },
