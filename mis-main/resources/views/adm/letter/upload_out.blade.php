                ...
                <div class="card card-primary card-outline card-tabs">
                    <div class="card-header p-0 pt-1 border-bottom-0">
                            <div class="card-header"><h4>Upload File<h4></div>
                                <div class="card-body">
                                        <form method="POST" action="{{ route('adm.store_upload_out') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group row" style="margin-bottom:unset;">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class=" col-form-label" style="font-weight:normal">{{ $req_ougoing_mail->letter_number }}</label>
                                                            @error('letter_number')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="hidden" name="id" id="id" value="{{ $req_ougoing_mail->id }}">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="col-form-label" style="font-weight:normal">{{ $req_ougoing_mail->attention_to }}</label>
                                                            @error('destination')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                         <label class="col-form-label" style="font-weight:normal">{{ $req_ougoing_mail->company }}</label>
                                                            @error('destination')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="col-form-label" style="font-weight:normal">{{ $req_ougoing_mail->subject }}</label>
                                                            @error('destination')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="col-form-label" style="font-weight:normal">{{ $req_ougoing_mail->from }}</label>
                                                            @error('destination')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="col-form-label" style="font-weight:normal">{{ $req_ougoing_mail->note }}</label>
                                                            @error('destination')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
